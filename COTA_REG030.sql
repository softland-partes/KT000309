...
'@@@@@@' FLD005,
'R' FLD006,
SPACE(69) FLD007, /* OBL Texto correspondiente a los comprobantes y retenciones.*/
SPACE (733) FLD008,
REPLICATE('0',13) FLD009,
SPACE(3) FLD010,
(CJRMVI.CJRMVI_CODEMP + CJRMVI_MODFOR + CJRMVI_CODFOR + CONVERT(VARCHAR,CJRMVI_NROFOR))+CONVERT(VARCHAR,4) FLD080 /*Orden de Registro*/

FROM PVMPRH
INNER JOIN CJRMVI ON
